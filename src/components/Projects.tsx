...
import { Code, Database, Globe, ExternalLink, Users } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex justify-between items-center">
              ...
              <ExternalLink className="w-5 h-5 text-gray-400 hover:text-green-600 cursor-pointer" />
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex justify-between items-center">
              ...
              <ExternalLink className="w-5 h-5 text-gray-400 hover:text-purple-600 cursor-pointer" />
            </div>
          </div>
