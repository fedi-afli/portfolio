      ...
      <div *ngIf="cart" class="card">
        ...
        <div class="card-body">
          ...
          <div *ngIf="cart.cartLigns.length > 0">
            <div class="row mb-3" *ngFor="let item of cart.cartLigns; trackBy: trackByCartItem">
              <div class="col-md-8">
  ...
  confirmOrder() {
    this.apiService.confirmCart(this.userId).subscribe({
      next: (order) => {
        ...
        console.log(`Order ${order.orderDate} confirmed successfully.`);
      ...
      error: (error) => {
        ...
        console.log('Error confirming order. Please try again.');
      }
    });
  }
