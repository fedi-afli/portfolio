...
WebUI.setText(findTestObject('Object Repository/Page_Create Account/input_ZIP Code_postcode'), '14852')
...
WebUI.verifyTextPresent('This login name is not available', false)
