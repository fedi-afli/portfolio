...
WebUI.setText(findTestObject('Object Repository/Page_Create Account/input_E-Mail_email'), 'saidaniyasser938@gmail.com')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Create Account/select_--- Please Select --- AberdeenAberde_0b0437'), 
    '3523', true)

WebUI.setText(findTestObject('Object Repository/Page_Create Account/input_ZIP Code_postcode'), '147852')
...
WebUI.setText(findTestObject('Object Repository/Page_Create Account/input_Login name_loginname'), 'yesser999')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Create Account/input_Password_password'), 'wEZMzqsNrqa8jgvESMO8LQ==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Create Account/input_Password Confirm_confirm'), 'wEZMzqsNrqa8jgvESMO8LQ==')
